...
The above queries can be run with the advance search option at https://scopus.com and are generated from the API queries actually used. The change is replacing '+' with ' '. An account is required which is included for many education institutions. 
